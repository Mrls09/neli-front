...
export const EditCamisaForm = ({
  ...
  React.useMemo(() => {
    const { id, specNo, grade, type, smys, status } = objeto;
    form.values.id = id;
    form.values.specNo = specNo;
  ...
  return (
    ...
    >
      <Modal.Header closeButton>
        <Modal.Title>Actualizar Material Camisa</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        <Form onSubmit={form.handleSubmit}>
          <Form.Group as={Row} className="mb-3">
            ...
            <Form.Control
              name="specNo"
              value={form.values.specNo}
              onChange={form.handleChange}
            />
            {form.errors.specNo && (
              <span className="error-text">{form.errors.specNo}</span>
            )}
          </Form.Group>
          <Form.Group as={Row} className="mb-3">
          ...
          <Form.Group as={Row} className="mb-3">
            ...
            />
            {form.errors.type && (
              <span className="error-text">{form.errors.type}</span>
            )}
          </Form.Group>
          <Form.Group as={Row} className="mb-3">
