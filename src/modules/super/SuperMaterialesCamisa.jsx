...
import { AddCamisaForm } from './SuperForms/AddCamisaForm';
import { EditCamisaForm } from './SuperForms/EditCamisaForm';




export default function SuperMaterialesCamisa() {
    ...
    return (
        < >
            ...
            <AddCamisaForm isOpen={isOpen} cargarDatos={cargarDatos} onClose={() => setIsOpen(false)} />
            <EditCamisaForm isOpen={isEditing} cargarDatos={cargarDatos} onClose={() => setIsEditting(false)} objeto={selectedObject}/>
        </>
